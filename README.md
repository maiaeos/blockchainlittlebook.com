...
现在应该是：
「李的话听一半，李的科普可以看，李推荐的工具没必要用，李建议的币千万别买。」（除了BTC）
...
李老师和EOS比较明确的关系为，1.公开表示硬币资本曾在15年左右以天使投资的身份占有**过**Blockone公司不到5%的股份。2.17年利用pressone项目的ico，低价吸走过早期eos超过20%流通市值的eos。
...
比如 EOS 中 BM 为了提高确认速度，让每一个BP（区块生产者，也称超级节点）连续生产6个区块，轮到下一个BP生产区块时，无论前一个BP是否生产足够6个区块，当前的BP也会继续出块。这样就很容易让EOS在不停的分叉中出块。但从没听说 EOS 因为这个机制，不断的改名字，以及分出新的币。
...
EOS的共识机制为DPOS+PBFT。是对POS与BFT共识机制的优秀改进与应用。dpos当然不等于pos。混淆pos和dpos在一年前还是比较有市场的，当时https://www.stakingrewards.com/charts 的数据看，eos的“s”量，比pos类公链前十加起来还多。可是时至今日我们再看该网站统计。第二第三第四加起来总和的“s”量就已经超越了EOS。他们所代表的Tendermint等pos改进机制同样优秀。我们可以看到eos在pos版图中的霸主地位是肉眼可见的速度在跌落。
